  ...
  __onReady(function init(){
    ...
    const TXT = {
      cs: {
        ...
        fsCancel: 'Výběr složky zrušen/selhal. Použiji výchozí „Stažené soubory“.',
          ...
          <div id="grp-dest" style="display:${viewMode==='download'?'block':'none'};">
            ...
            <div style="display:flex;gap:6px;align-items:center;flex-wrap:wrap;">
              <button id="e6-choose-dir" type="button"
                      style="padding:6px 8px;border-radius:8px;background:#ffee95;border:none;color:#9da6ad;cursor:pointer;">${t('chooseFolder')}</button>
    ...
    function startOrPause(){
      ...
      if (!running){
        ...
        if (!found.length){ el.note.textContent = TXT[lang].nothing; publishLocalStatus(TXT[lang].nothing); return; }
